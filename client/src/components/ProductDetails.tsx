        ...
        <div className="flex flex-col h-full">
          <div className="border-b border-gray-100 pb-6">
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="bg-zinc-100 text-zinc-800 text-xs font-bold px-3 py-1 rounded-full uppercase">
          ...
          <div className="mt-auto space-y-4">
            ...
            <p className="text-center text-xs text-gray-400 uppercase tracking-tighter italic">
